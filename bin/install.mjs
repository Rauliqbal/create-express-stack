...
// ASCII ART
const asciiArt = `                                             
 _______  __   __  _______  ______    _______  _______  _______  _______  _______  _______  ___   _ 
|       ||  |_|  ||       ||    _ |  |       ||       ||       ||       ||   _   ||       ||   | | |
|    ___||       ||    _  ||   | ||  |    ___||  _____||  _____||_     _||  |_|  ||       ||   |_| |
|   |___ |       ||   |_| ||   |_||_ |   |___ | |_____ | |_____   |   |  |       ||       ||      _|
|    ___| |     | |    ___||    __  ||    ___||_____  ||_____  |  |   |  |       ||      _||     |_ 
|   |___ |   _   ||   |    |   |  | ||   |___  _____| | _____| |  |   |  |   _   ||     |_ |    _  |
|_______||__| |__||___|    |___|  |_||_______||_______||_______|  |___|  |__| |__||_______||___| |_|       
`;

const templates = ["ExpressJS", "ExpressTS"];
